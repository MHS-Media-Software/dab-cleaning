...
export const metadata = {
  title: "DAB Cleaning — Professionele Schoonmaakdiensten",
  description: "DAB Cleaning biedt professionele schoonmaakdiensten voor bedrijven, instellingen en particulieren. Van dagelijkse onderhoudsschoonmaak tot bouwschoonmaak. Vraag een vrijblijvende offerte aan.",
};
